...
namespace Audiology.Data.Migrations
{
    ...
    [Migration("20200307223925_mainModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Audiology.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("FavouritesId")
                        .IsUnique()
                        .HasFilter("[FavouritesId] IS NOT NULL");
            ...
            modelBuilder.Entity("Audiology.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Audiology.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("Audiology.Data.Models.Favourites", "Favourites")
                        .WithOne("User")
                        .HasForeignKey("Audiology.Data.Models.ApplicationUser", "FavouritesId");
